...
final class DatabaseTests: XCTestCase {
    ...
    func testDatabase() async throws {
        ...
        await Database.shared.addUser(name:"Joe", username: "Joe",password: "hellothere", phoneNumber: "555-666-7777", emergencyContact: testEC, address: "101 That Lane", email: "joe@email.com")
        ...
        XCTAssertEqual(updatedUser?.emergencyContact.name, "Tom", "Emergency contact update failed!")
